...
export function FrenteList() {
  ...
  const filtered = sortedFrentes.filter(
    (f) =>
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center gap-2 max-w-sm">
        <h2 className="sr-only">Filtros de Frentes</h2>
